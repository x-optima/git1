...
## <h2 style="color:red;">ОТВЕТ</h2> ##

1. Аккаунт на gitlab создан, репозиторий запушен.  

Скриншоты.  
![Задание 1. Скриншот 1](screenshots2/scr1_1.png)



### Bitbucket* (задание со звёздочкой) 
## <h2 style="color:red;">НЕТ ДОСТУПА К BITBUCKET</h2> ##
...
## <h2 style="color:red;">ОТВЕТ 2</h2> ##

1. Создаем сначала лекговесный тег.
2. Создаем аннотированный тег.
3. Запушим файлы с тегами на ithib и gitlab. 
4. Оба тега указывают на один и тот же коммит d1f40af.   

Скриншоты.  
![Задание 2. Скриншот 1](screenshots2/scr2_1.png)
![Задание 2. Скриншот 2](screenshots2/scr2_2.png)
![Задание 2. Скриншот 3](screenshots2/scr2_3.png)
![Задание 2. Скриншот 3](screenshots2/scr2_4.png)
